from legal_ai.ingestion.crawler import Crawler
from legal_ai.constants import URL
from legal_ai.storage.source_store import SourceStore
from legal_ai.storage.task_store import TaskStore
from legal_ai.storage.target_store import TargetStore
